...
/**
 * Plugin Name: Tabs Options
 * Plugin URI: http://www.domain.tld
 * Plugin Prefix: tabs_options
 * Plugin ID: tabs-options
 * Description: Create option page with a tab display
 * Version: 1.0.0
 * Author: Quentin Honnart
 * Author URI: https://framework.themosis.com/
 * Text Domain: tabs-options
 * Domain Path: languages
 * Domain Var: TABS_OPTION_TD
